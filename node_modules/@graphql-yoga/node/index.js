...
class YogaNodeServer extends core.YogaServer {
    constructor(options) {
        var _a;
        super({
            ...options,
    ...
    stop() {
        ...
        return new Promise((resolve, reject) => {
            if (!this.nodeServer) {
                reject(new core.GraphQLYogaError('Server not running.'));
                return;
            }
